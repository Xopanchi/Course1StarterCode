...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 25, 25, 350, 550, provider);
		...
		map2 = new UnfoldingMap(this, 425, 25, 350, 550, provider);
		
		// The next line zooms in and centers the map at 
	    // 42.32 (latitude) and -8.79 (longitude) BUEU
	    map2.zoomAndPanTo(zoomLevel, new Location(42.32f, -8.79f));
